...
class OAuthService:
    ...
    async def handle_google_callback(self, code: str, db: AsyncSession) -> Dict[str, Any]:
    ...
    async def handle_linkedin_callback(self, code: str, db: AsyncSession) -> Dict[str, Any]:
    ...
    async def handle_tiktok_callback(self, code: str, db: AsyncSession) -> Dict[str, Any]:
    ...
    async def _generate_unique_username(self, base_username: str, db: AsyncSession) -> str:
