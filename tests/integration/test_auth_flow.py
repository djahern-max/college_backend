...
class TestUserLogin:
    ...
    def test_login_success_oauth2_form(self, client: TestClient, test_user: User):
    ...
    def test_jwt_token_contains_user_id(self, client: TestClient, test_user: User):
...
class TestProtectedEndpoints:
    ...
    def test_get_current_user_expired_token(self, client: TestClient, test_user: User):
        ...
        expired_token = create_access_token(
            subject=str(test_user.id), expires_delta=timedelta(minutes=-1)
        )
...
class TestAdminUser:
    ...
    def test_admin_user_login(self, client: TestClient, admin_user: User):
    ...
    def test_admin_user_has_superuser_flag(
        ...
        """Test admin user has correct email"""
