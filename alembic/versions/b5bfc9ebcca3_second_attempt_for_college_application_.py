"""SECOND ATTEMPT FOR COLLEGE APPLICATION TABLE

Revision ID: b5bfc9ebcca3
Revises: ccde1d6c3a7e
Create Date: 2025-11-07 05:25:31.047680
...
revision: str = 'b5bfc9ebcca3'
down_revision: Union[str, None] = 'ccde1d6c3a7e'
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('RESEARCHING', 'PLANNING', 'IN_PROGRESS', 'SUBMITTED', 'ACCEPTED', 'WAITLISTED', 'REJECTED', 'DECLINED', 'ENROLLED', name='applicationstatus'), nullable=False),
    sa.Column('application_type', sa.Enum('EARLY_DECISION', 'EARLY_ACTION', 'REGULAR_DECISION', 'ROLLING', name='applicationtype'), nullable=True),
