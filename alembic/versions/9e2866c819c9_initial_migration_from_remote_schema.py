"""initial migration from remote schema

Revision ID: 9e2866c819c9
Revises: 
Create Date: 2025-09-17 09:47:25.572012
...
def upgrade() -> None:
    ...
    sa.Column('required_fees', sa.Float(), nullable=True),
    sa.Column('tuition_fees_in_state', sa.Float(), nullable=True),
    sa.Column('tuition_fees_out_state', sa.Float(), nullable=True),
    sa.Column('room_board_on_campus', sa.Float(), nullable=True),
    sa.Column('room_board_off_campus', sa.Float(), nullable=True),
    sa.Column('books_supplies', sa.Float(), nullable=True),
    sa.Column('personal_expenses', sa.Float(), nullable=True),
    sa.Column('transportation', sa.Float(), nullable=True),
    sa.Column('has_tuition_data', sa.Boolean(), nullable=True),
    sa.Column('has_fees_data', sa.Boolean(), nullable=True),
