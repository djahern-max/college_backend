"""Initial migration with improved IPEDS data

Revision ID: 78513576aa36
Revises: 
Create Date: 2025-09-06 10:52:19.381755
...
def upgrade() -> None:
    ...
    op.create_table('college_favorites',
    ...
    op.create_index(op.f('ix_college_favorites_college_id'), 'college_favorites', ['college_id'], unique=False)
    op.create_index(op.f('ix_college_favorites_id'), 'college_favorites', ['id'], unique=False)
    op.create_index(op.f('ix_college_favorites_user_id'), 'college_favorites', ['user_id'], unique=False)
    op.create_table('college_saved_searches',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_college_saved_searches_id'), 'college_saved_searches', ['id'], unique=False)
    op.create_index(op.f('ix_college_saved_searches_user_id'), 'college_saved_searches', ['user_id'], unique=False)
    ...
    sa.Column('college_type', sa.Enum('PUBLIC', 'PRIVATE_NONPROFIT', 'PRIVATE_FOR_PROFIT', name='collegetype'), nullable=False),
    sa.Column('size_category', sa.Enum('VERY_SMALL', 'SMALL', 'MEDIUM', 'LARGE', 'VERY_LARGE', name='collegesize'), nullable=True),
    sa.Column('carnegie_classification', sa.Enum('R1_VERY_HIGH_RESEARCH', 'R2_HIGH_RESEARCH', 'DOCTORAL_PROFESSIONAL', 'MASTERS_LARGE', 'MASTERS_MEDIUM', 'MASTERS_SMALL', 'BACCALAUREATE_ARTS_SCIENCES', 'BACCALAUREATE_DIVERSE', 'ASSOCIATES_HIGH_TRANSFER', 'ASSOCIATES_MIXED', 'ASSOCIATES_HIGH_CAREER', 'SPECIAL_FOCUS', name='carnegieclassification'), nullable=True),
    sa.Column('is_hbcu', sa.Boolean(), nullable=True),
    sa.Column('is_hsi', sa.Boolean(), nullable=True),
    sa.Column('is_tribal', sa.Boolean(), nullable=True),
    sa.Column('is_women_only', sa.Boolean(), nullable=True),
    sa.Column('is_men_only', sa.Boolean(), nullable=True),
    ...
    sa.Column('percent_women', sa.Float(), nullable=True),
    sa.Column('percent_men', sa.Float(), nullable=True),
    sa.Column('acceptance_rate', sa.Float(), nullable=True),
    sa.Column('yield_rate', sa.Float(), nullable=True),
    sa.Column('sat_reading_25', sa.Integer(), nullable=True),
    sa.Column('sat_reading_75', sa.Integer(), nullable=True),
    sa.Column('sat_math_25', sa.Integer(), nullable=True),
    sa.Column('sat_math_75', sa.Integer(), nullable=True),
    sa.Column('sat_total_25', sa.Integer(), nullable=True),
    sa.Column('sat_total_75', sa.Integer(), nullable=True),
    sa.Column('act_composite_25', sa.Integer(), nullable=True),
    sa.Column('act_composite_75', sa.Integer(), nullable=True),
    sa.Column('act_english_25', sa.Integer(), nullable=True),
    sa.Column('act_english_75', sa.Integer(), nullable=True),
    sa.Column('act_math_25', sa.Integer(), nullable=True),
    sa.Column('act_math_75', sa.Integer(), nullable=True),
    sa.Column('requires_sat_act', sa.Boolean(), nullable=True),
    sa.Column('is_test_optional', sa.Boolean(), nullable=True),
    sa.Column('requires_essay', sa.Boolean(), nullable=True),
    sa.Column('requires_interview', sa.Boolean(), nullable=True),
    sa.Column('tuition_in_state', sa.Integer(), nullable=True),
    sa.Column('tuition_out_state', sa.Integer(), nullable=True),
    sa.Column('required_fees', sa.Integer(), nullable=True),
    sa.Column('room_and_board', sa.Integer(), nullable=True),
    sa.Column('total_cost_in_state', sa.Integer(), nullable=True),
    sa.Column('total_cost_out_state', sa.Integer(), nullable=True),
    sa.Column('percent_receiving_aid', sa.Float(), nullable=True),
    sa.Column('average_aid_amount', sa.Integer(), nullable=True),
    sa.Column('percent_need_met', sa.Float(), nullable=True),
    sa.Column('student_faculty_ratio', sa.Float(), nullable=True),
    sa.Column('graduation_rate_4_year', sa.Float(), nullable=True),
    sa.Column('graduation_rate_6_year', sa.Float(), nullable=True),
    sa.Column('retention_rate', sa.Float(), nullable=True),
    sa.Column('popular_majors', postgresql.ARRAY(sa.String()), nullable=True),
    sa.Column('all_majors_offered', postgresql.ARRAY(sa.String()), nullable=True),
    sa.Column('offers_online_degrees', sa.Boolean(), nullable=True),
    sa.Column('offers_part_time', sa.Boolean(), nullable=True),
    sa.Column('offers_weekend_college', sa.Boolean(), nullable=True),
    sa.Column('campus_setting', sa.String(length=50), nullable=True),
    sa.Column('campus_size_acres', sa.Integer(), nullable=True),
    sa.Column('percent_students_on_campus', sa.Float(), nullable=True),
    sa.Column('housing_required', sa.Boolean(), nullable=True),
    sa.Column('ncaa_division', sa.String(length=10), nullable=True),
    sa.Column('athletic_conference', sa.String(length=100), nullable=True),
    sa.Column('median_earnings_6_years', sa.Integer(), nullable=True),
    sa.Column('median_earnings_10_years', sa.Integer(), nullable=True),
    sa.Column('employment_rate', sa.Float(), nullable=True),
    sa.Column('rankings_data', sa.JSON(), nullable=True),
    ...
    op.create_index(op.f('ix_colleges_carnegie_classification'), 'colleges', ['carnegie_classification'], unique=False)
    ...
    op.create_index(op.f('ix_colleges_size_category'), 'colleges', ['size_category'], unique=False)
    op.create_index(op.f('ix_colleges_state'), 'colleges', ['state'], unique=False)
    op.create_index(op.f('ix_colleges_unitid'), 'colleges', ['unitid'], unique=True)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_colleges_unitid'), table_name='colleges')
    op.drop_index(op.f('ix_colleges_state'), table_name='colleges')
    op.drop_index(op.f('ix_colleges_size_category'), table_name='colleges')
    ...
    op.drop_index(op.f('ix_colleges_carnegie_classification'), table_name='colleges')
    op.drop_table('colleges')
    op.drop_index(op.f('ix_college_saved_searches_user_id'), table_name='college_saved_searches')
    op.drop_index(op.f('ix_college_saved_searches_id'), table_name='college_saved_searches')
    op.drop_table('college_saved_searches')
    op.drop_index(op.f('ix_college_favorites_user_id'), table_name='college_favorites')
    op.drop_index(op.f('ix_college_favorites_id'), table_name='college_favorites')
    op.drop_index(op.f('ix_college_favorites_college_id'), table_name='college_favorites')
    op.drop_table('college_favorites')
    # ### end Alembic commands ###
